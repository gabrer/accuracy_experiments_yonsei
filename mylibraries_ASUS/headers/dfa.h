...
class dfa
{
	protected:
		...
		string* alphabet;														/*!< Alphabet symbols */
		map<string, SYMBOL> mapped_alphabet;				/*!< Convert symbols into indices */
	...
	public:
		...
		vector<vector<SYMBOL>> 		get_characterization_set();
		...
		map<int, vector<SYMBOL>>  	get_access_strings();

		vector<string> 				get_access_strings_with_alphabet_symbols();
